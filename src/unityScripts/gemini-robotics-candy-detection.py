...
3. Returns bounding box coordinates + labels for each element
...
- Returns bounding boxes in [y_min, x_min, y_max, x_max] format normalized to 0-1000
...
Output:
- Each interactable element gets its own bounding box
...
def convert_normalized_bbox_to_pixels(bbox_norm, image_width, image_height):
    """
    Convert normalized bounding box to pixel coordinates.
    
    Args:
        bbox_norm: [y_min, x_min, y_max, x_max] in normalized 0-1000 format
...
def detect_interactable_elements(image_path, api_key=GOOGLE_API_KEY, model_name=MODEL_NAME):
    ...
    3. Parse the response with bounding box coordinates and descriptions
    4. Convert normalized bounding boxes to pixel coordinates
    ...
    Returns:
        ...
        - 'bounding_box_norm': [y_min, x_min, y_max, x_max] in normalized 0-1000 format
...
Detect as many interactable elements as you can find. Be thorough!"""
    ...
    # ========================================================================
    # STEP 5: Convert normalized bounding boxes to pixel coordinates
    # ========================================================================
    results = []
    ...
    for idx, detection in enumerate(detections, 1):
        ...
        bbox = convert_normalized_bbox_to_pixels(bbox_norm, image_width, image_height)
        ...
        print(f"   📊 Normalized bbox: {bbox_norm} (y_min, x_min, y_max, x_max in 0-1000)")
