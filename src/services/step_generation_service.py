...
- assertions: test cases to verify, each with id ("1", "2", so and so), title (≤5 words naming what is being tested), description (the expected outcome — what the game should do for this assertion to pass). The number of assertions should be equal to the number of VERIFY steps and chronologically they should represent the same verification.
